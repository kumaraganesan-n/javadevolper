...
export const Recruite=()=>{
    ...
    <div className="containner-fluid mt-5">
        ...
        <div className="col-lg-7 col-md-10 col-sm-12 shadow-lg p-3">
            <div className="form grouph">
                ...
                <div className="mt-4 row justify-content-around">
                    <button onClick={kumaran} className="col-2 btn btn-outline-success">Hire</button>
                            <button onClick={ganesan} className="col-2 btn btn-outline-danger">Cancel</button>
